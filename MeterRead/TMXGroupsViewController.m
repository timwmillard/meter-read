...
#import "TMXGroupsViewController.h"

#import "TMXAppDelegate.h"

@interface TMXGroupsViewController ()

@end

@implementation TMXGroupsViewController
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = group.importDateTimeString;
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *dateTimeSortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"importDateTime" ascending:NO];
    NSArray *sortDescriptors = @[dateTimeSortDescriptor];
